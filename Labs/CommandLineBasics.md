...
This document outlines basic usage of the command line. These commands will work in your Anaconda environment created as 
directed in the [Installation Checklist](./Installation Checklist.md)
For Linux and Mac users, these commands also work in **Terminal**. For Windows users, these should work in **Git Bash**.
