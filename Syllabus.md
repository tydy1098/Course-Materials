...
Who | When
--- | ---
Prof. Haining | Sundays 3-6pm at GA
Eliz | Fridays 6-8pm at GA
* Slack
...
* Help students, including those who do not plan to major in Computer Science, feel confident of their ability to write small programs that allow them to accomplish useful goals.
* Position students so that they can compete for research projects and excel in subjects with programming components.
* Familiarilty and confidence when confronted with new technology
...
| Tuesday | Thursday
|--- | ---
|Jan 14 : [Tools of the Trade](#class-1-introduction-to-data-science) | Jan 16: [Python as Calculator](#class-2-version-control)
|Jan 21: [Python Strings](#class-3-intro-to-python) | Jan 23: [Functions and Modules](#class-4-intro-to-machine-learning--classification-with-knn)
|Jan 28: [Python Functions](#class-5-numpy--pandas-visualization-model-evaluation) | Jan 30: [Decisions](#class-6-regression-and-regularization) <br>**Project Question & Dataset Due**
|Feb 4: Tuples, Modules Images  | 12/23: Lists Part 1
|Feb 11: While Loops  | 12/30:  
|Feb 18: **No Class** (Holiday Break) | **No Class** (Holiday Break)
|Feb 25: [Lists Part 2](#class-9-clustering) | 1/13: [Decisions Part 2](#class-10-apis--web-scraping)
|Mar 3:  Controlling Loops | 1/20: [Data from Files](#class-11-advanced-model-evaluation) <br>**Project First Draft Due**
|Mar 10: [Problem Solving and Design, Part 1](#class-12-decision-trees) | 1/27: [Sets](#class-13-ensembles-and-random-forests)
|Mar 17: [Dictionaries Part 1](#class-14-support-vector-machines) | 2/3: [Dictionaries, Part 2](#class-15-dimensionality-reduction)
|Mar 24: [Classes](#class-16-recommender-systems) | 2/10: [Searching](#class-17-text-processing--nlp) <br>**Peer Feedback on Project Drafts Due**
|Mar 31: Sorting | 2/17: [ ](#class-18-database-technologies--sql) <br>**Project Second Draft Due (Optional)**</br>
|Apr 7:  | 2/17: [ ](#class-18-database-technologies--sql) <br>**Project Second Draft Due (Optional)**
|Apr 14: **Finals**   | 2/17:  
...
--- | ---
Class Attendance/Citizenship	| 10%
Quizzes (drop lowest three) 	| 10%
Lyceum Prompts	|10%
Paper 1, due February 15 at start of class	|10%
Paper 2, due April 5 at start of class	|10%
Exam 1, Friday, February 1	|15%
Exam 2, Monday, March 18	|15%
Final Exam, Wednesday, April 10, 8-10am	|20%
TOTAL	|100%

## Policies
###  Attendance

* In general, class attendance is assumed and __expected__. This course involves active in-class learning and assessment. Your presence and participation are required.
* Recognizing that illnesses and other situations may occur, you may miss a total of two classes (the equivalent of one week) without penalty.  Arriving late or leaving early counts as one third of an absence.
* If you miss more than a total of two classes, the class attendance portion of your grade will be negatively affected.
* Official Bates notification is not required for most absences due to illness. Instead, simply email the professor. Such absences are applied to your two total permitted absences.
* Official Bates notification (for example, from Health Services) is required for absences on project presentation days.
* Discuss scheduled absences with the professor in advance. 
	* Scheduled absences for official Bates activities, such as debate tournaments or sports, are not applied to the two total permitted absences. 
	* Other absences typically are applied to the two total permitted absences. 
* For additional information on the [Bates College Course Attendance policy](https://www.bates.edu/student-affairs/student-support-and-advising/course-attendance-policy-guidelines-for-absences/)

### Technological Distractions
While computers are an essential part of this class, you are not expected to use them for non-class activities.  These include, but are not limited to, e-mail, Facebook, Twitter, Instagram, YouTube, Netflix.

If you are using your device for non-class work, you will not receive any participation credit for 
that class session.  If you are watching videos or listening to music, you will not receive any 
participation credit and I will ask you to leave the classroom.  

__Cell Phones__ must be turned off and off the desk
